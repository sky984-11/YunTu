        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20 flex items-center justify-between relative lg:static">
                <a class="flex items-center" href="#">
                    ...
                    <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">SkyLedger</span>
                </a>
                <Button
                    class="lg:!hidden"
                    text
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-12 md:col-span-2">
                        <a @click="smoothScroll('#home')" class="flex flex-wrap items-center justify-center md:justify-start md:mb-0 mb-4 cursor-pointer">
                            ...
                            <h4 class="font-medium text-3xl text-surface-900 dark:text-surface-0">SkyLedger</h4>
                        </a>
                    </div>
